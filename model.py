...
from Networks import Vits_Network, VGG_Network, Resnet50_Network, InceptionV3_Network
...
class FGSBIR_Model(nn.Module):
    def __init__(self, hp):
        ...
        self.sample_embedding_network = eval(hp.backbone_name)
        self.loss = nn.TripletMarginLoss(margin=0.2)
        self.sample_train_params = self.sample_embedding_network.parameters(self)
